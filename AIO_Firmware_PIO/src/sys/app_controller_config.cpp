...
void AppController::read_config(SysUtilConfig *cfg)
{
    ...
    if (size == 0)
    {
        ...
        cfg->auto_start_app = "None";  // No specified APP to auto-start on boot
    ...
    else
    {
        ...
        cfg->auto_start_app = param[11]; // Name of the APP to auto-start on boot
    }
}
...
void AppController::write_config(SysUtilConfig *cfg)
{
    ...
    // Apply relevant configurations immediately
                                ...
                                const char *key, char *value)
{
    ...
    case APP_MESSAGE_WRITE_CFG:
    {
        ...
        // write_config(&mpu_cfg);  // Already written once when auto-calibration is disabled
